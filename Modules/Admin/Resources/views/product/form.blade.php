            ...
            <div class="col-sm-9">
                ...
                <div class="product-content row">
                    <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" type="number" value="{{isset($product)?$product->pro_price:''}}" id="pro-price" name="pro_price">
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="pro-price-discount" class="col-5 col-form-label">Giá khuyến mãi</label>
                        <input class="form-control" type="number" value="{{isset($product)?$product->pro_price_discount:''}}" id="pro-price-discount" name="pro_price_discount">
                    </div>
                    <div class="form-group col-sm-4">
                        <label class="col-5 col-form-label">Kho</label>
                        <input class="form-control" type="number" value="{{isset($product)?$product->pro_stock:''}}" name="pro_stock">
                    </div>
                </div>
                <div class="product-content">
